...
const ClientSettings = () => {
  ...
  const fetchSettings = async () => {
    try {
      setLoading(true);
      const res = await smartErpApi.getClientSystemSettings();
      if (res.data) {
      ...
      console.error(err);
      setMessage({ text: "Failed to load tenant settings.", type: "danger" });
    } finally {
      setLoading(false);
    }
  };
  ...
  const handleSave = async (e) => {
    ...
    try {
      ...
      await smartErpApi.updateClientSystemSettings(payload);
      setMessage({ text: "Tenant settings saved successfully!", type: "success" });
    } catch (err) {
      console.error(err);
      setMessage({ text: "Failed to save tenant settings.", type: "danger" });
    } finally {
      setSaving(false);
    }
  };
    ...
    <div className="container-fluid py-4">
      ...
      <div className="card shadow-sm border-0">
        <div className="card-header bg-white border-bottom-0 pt-4 pb-0">
          <h5 className="mb-0">Tenant SMTP Configuration</h5>
          <small className="text-muted">Configure the custom email sender for your tenant.</small>
        </div>
              ...
              <div className="col-md-6 mb-3">
                <div className="form-group">
                  ...
                  <input
                    ...
                    onChange={handleChange}
                    placeholder="e.g. My Company Tenant"
                  />
                </div>
              </div>
