          ...
          <div style={{ background: "white", padding: "24px", borderRadius: "12px", boxShadow: "0 4px 6px -1px rgba(0,0,0,0.05)" }}>
            ...
            {labelList.length === 0 ? (
              ...
              <div style={{ maxHeight: "400px", overflowY: "auto", padding: "10px", border: "1px solid #e2e8f0", borderRadius: "8px" }}>
                <div ref={printRef} style={{ display: "grid", gridTemplateColumns: "1fr 1fr", gap: "20px", padding: "20px" }}>
                  {labelList.map(lbl => (
                    <div key={lbl.id} style={{ border: "1px solid #cbd5e1", padding: "15px", borderRadius: "6px", display: "flex", flexDirection: "column", alignItems: "center", background: "#fff", pageBreakInside: "avoid" }}>
